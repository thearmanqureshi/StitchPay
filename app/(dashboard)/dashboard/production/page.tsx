          ...
          <div className="table-card-header">
            <div>
              ...
              <p className="table-card-sub">
                {currentMonthLabel} · {filteredEntries.length}{" "}
                {filteredEntries.length === 1 ? "entry" : "entries"} logged
              </p>
            </div>
          </div>
                ...
                {loading ? (
                  ...
                  filteredEntries.map((entry) => (
                    <tr key={entry.id}>
                      ...
                      <td>
                        <span
                          className={`badge ${entry.department === "Production" ? "badge-dept-prod" : "badge-dept-fin"}`}
                        >
                      ...
                      <td className="pe-amount">
                        ₹{entry.amount_earned.toLocaleString("en-IN")}
                      </td>
